(define-module (takeguix packages emacs-exwm)
...
(define-public emacs-exwm-with-nativecomp
  (package
   (name "emacs-exwm-with-nativecomp")
   (version "0.26")
   (synopsis "Emacs X window manager with nativecomp")
   (source
    (origin
     (method url-fetch)
